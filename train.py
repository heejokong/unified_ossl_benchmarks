...
def get_config():
    ...
    parser.add_argument('--eval_batch_size', type=int, default=256, help='batch size of evaluation data loader (it does not affect the accuracy)')
    ...
    """ """
    parser.add_argument('--correlated_ood', type=str2bool, default=False)
    parser.add_argument('--mm_ablation', type=str2bool, default=False)
